...
\newcommand{\groupID}{AISL-1-2425-C3} % group ID is for undergraduates as of this formatting
...
\defineAuthor{firstname1}{John Carlo Theo S.}

\defineAuthor{surname2}{Parel}
\defineAuthor{firstname2}{Pierre Justine P.}

\defineAuthor{surname3}{Tabiolo}
\defineAuthor{firstname3}{Jiro Renzo D.}

\defineAuthor{surname4}{Valencerina}
\defineAuthor{firstname4}{Ercid Bon B.}

\newcommand{\documentTitle}{Two-Stage Automated Coffee Bean Sorter: A Precise System for Green Coffee Beans Using Machine Vision and Density-Based Analysis} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{computer vision, deep learning, density-based analysis, Arabica, green coffee beans, sorting}
